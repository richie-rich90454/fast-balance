...
export default defineConfig({
    ...
    head: [
        ...
        [
            "meta",
            { property: "og:url", content: "https://richie-rich90454.github.io/fast-balance/" },
        ],
        [
            "meta",
            {
                name: "keywords",
                content:
                    "chemistry, chemical equation, balancer, stoichiometry, redox, isotope, nuclear, chemistry library, javascript, typescript",
            },
        ],
    ],
    ...
    themeConfig: {
        ...
        socialLinks: [{ icon: "github", link: "https://github.com/richie-rich90454/fast-balance" }],
