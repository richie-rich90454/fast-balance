...
describe("Complexation Reactions: Ammonia Complexes", () => {
    it("Cu2+ + 4NH3 -> [Cu(NH3)4]2+", () => {
        try {
            const r = balance("Cu2+ + NH3 -> Cu(NH3)4+");
    ...
    it("Zn2+ + 4NH3 -> [Zn(NH3)4]2+", () => {
        try {
            const r = balance("Zn2+ + NH3 -> Zn(NH3)4+");
            checkPositiveIntegers(r);
        } catch (e: any) {
            expect(e.message).toMatch(
                /Unbalanceable|unbalanced|Cannot balance|Expected element|Impossible|Error/i,
    ...
    it("Ni2+ + 6NH3 -> [Ni(NH3)6]2+", () => {
        try {
            const r = balance("Ni2+ + NH3 -> Ni(NH3)6+");
            checkPositiveIntegers(r);
        } catch (e: any) {
            expect(e.message).toMatch(
                /Unbalanceable|unbalanced|Cannot balance|Expected element|Impossible|Error/i,
    ...
    it("Co2+ + 6NH3 -> [Co(NH3)6]2+", () => {
        try {
            const r = balance("Co2+ + NH3 -> Co(NH3)6+");
            checkPositiveIntegers(r);
        } catch (e: any) {
            expect(e.message).toMatch(
                /Unbalanceable|unbalanced|Cannot balance|Expected element|Impossible|Error/i,
...
describe("Complexation Reactions: Cyanide Complexes", () => {
    ...
    it("Fe2+ + 6CN- -> [Fe(CN)6]4-", () => {
        try {
            const r = balance("Fe2+ + CN- -> Fe(CN)6-");
            checkPositiveIntegers(r);
        } catch (e: any) {
            expect(e.message).toMatch(
                /Unbalanceable|unbalanced|Cannot balance|Expected element|Impossible|Error/i,
    ...
    it("Fe3+ + 6CN- -> [Fe(CN)6]3-", () => {
        try {
            const r = balance("Fe3+ + CN- -> Fe(CN)6-");
            checkPositiveIntegers(r);
        } catch (e: any) {
            expect(e.message).toMatch(
                /Unbalanceable|unbalanced|Cannot balance|Expected element|Impossible|Error/i,
    ...
    it("Ni2+ + 4CN- -> [Ni(CN)4]2-", () => {
        try {
            const r = balance("Ni2+ + CN- -> Ni(CN)4-");
            checkPositiveIntegers(r);
        } catch (e: any) {
            expect(e.message).toMatch(
                /Unbalanceable|unbalanced|Cannot balance|Expected element|Impossible|Error/i,
